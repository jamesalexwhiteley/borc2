...
def plotcontour2d(problem, gp1, gp2, nsamples, steps):  
...
def gaussian_process(): 
    ...
    os.makedirs(base_folder, exist_ok=True)
    output_path_1 = os.path.join(base_folder, "gp_deep_prestress_1")
    output_path_2 = os.path.join(base_folder, "gp_deep_prestress_2")
    ...
    plotcontour2d(problem, gp1, gp2, nsamples, steps)
